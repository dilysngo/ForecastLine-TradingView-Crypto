...
const renderChart = async (domElement, options) => {
  const { symbol, interval, limit } = options
  ...
  return (
    <div className='wrapper-chart'>
      <div className='focus-area'>
        ...
        <button onClick={() => setIntervalTime('1m')} style={{ color: interval === '1m' ? '#fff' : '' }}>
          1m
        </button>
        <button onClick={() => setIntervalTime('5m')} style={{ color: interval === '5m' ? '#fff' : '' }}>
          5m
        </button>
        <button onClick={() => setIntervalTime('1h')} style={{ color: interval === '1h' ? '#fff' : '' }}>
          1H
        </button>
        <button onClick={() => setIntervalTime('1d')} style={{ color: interval === '1d' ? '#fff' : '' }}>
          1D
        </button>
        <button onClick={() => setIntervalTime('3d')} style={{ color: interval === '3d' ? '#fff' : '' }}>
          3D
        </button>
        <button onClick={() => setIntervalTime('1w')} style={{ color: interval === '1w' ? '#fff' : '' }}>
          1W
        </button>
      </div>
